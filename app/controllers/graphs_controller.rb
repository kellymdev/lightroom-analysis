class GraphsController < ApplicationController
  ...
  def isos_by_camera_data
    respond_to do |format|
      format.json { render json: AgHarvestedExifMetadata.isos_by_camera_list.as_json }
    end
  end
  ...
  def lenses_by_camera_data
    respond_to do |format|
      format.json { render json: AgHarvestedExifMetadata.lenses_by_camera_list.as_json }
    end
  end
